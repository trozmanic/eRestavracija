...
const zaposleni = function (req, res) {
    ...
    res.render('nadzorna_plosca_zaposleni', { layout: 'layout_nadzorna_plosca.hbs', title: 'Nadzorna plošča - Zaposleni', zaposleni_role: vloga, uporabnik_id: id_u,u_ime:u_ime })
}
